...
//when you add tasks to the page and then reload the page the tasks will remain with the tasks that you orginially added
//when you close the tab and then reload the page the tasks will also remain in the tasks box